...
public final class HttpEngine {
  ...
  public void sendRequest() throws RequestException, RouteException, IOException {
    ...
    if (networkRequest != null) {
      ...
      try {
        ...
        StringBuilder sb = new StringBuilder("Khaled: Request stacktrace:\n");
        ...
        System.out.println("Khaled: Request stacktrace failed");
        e.printStackTrace();
      }
  ...
  public Response getResponse() {
    ...
    try {
      StackTraceElement [] stackTraceElements = Thread.currentThread().getStackTrace();
      StringBuilder sb = new StringBuilder("Khaled: Response get stacktrace:\n");
      for (StackTraceElement ste : stackTraceElements) {
          sb.append("    ");
          sb.append(ste.toString());
          sb.append("\n");
      ...
      sb.append("Request: ");
      sb.append(userRequest.toString());
      sb.append("\n");
      sb.append("Headers: ");
      sb.append(userRequest.headers().toString());
      sb.append("\n");
      sb.append("Response: ");
      sb.append(userResponse.toString());
      sb.append("\n");
      System.out.println(sb.toString());
    } catch (Exception e) {
      System.out.println("Khaled: Response get stacktrace failed");
      e.printStackTrace();
    }
