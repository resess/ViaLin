...
$(built_dex): $(built_dex_intermediate)
  ...
  # Khaled: taint code, replaces above commented code
	$(hide) mkdir -p $(dir $@)
	$(hide) rm -f $(dir $@)/classes*.dex
	rm -rf $(dir $@)/temp
	mkdir -p $(dir $@)/temp
	@echo Khaled, will run command java -Xss16M -jar /home/khaledea/data/ViaLin/ViaLin/target/vialin-jar-with-dependencies.jar t true false vl $(dir $@)/temp/ /home/khaledea/data/ViaLin/framework_analysis_results /home/khaledea/data/ViaLin/methodSummaries /home/khaledea/data/ViaLin/scripts/empty.txt /home/khaledea/data/ViaLin/scripts/empty.txt $(dir $<)/classes*.dex
	java -Xss16M -jar /home/khaledea/data/ViaLin/ViaLin/target/vialin-jar-with-dependencies.jar t true false vl $(dir $@)/temp/ /home/khaledea/data/ViaLin/framework_analysis_results /home/khaledea/data/ViaLin/methodSummaries /home/khaledea/data/ViaLin/scripts/empty.txt /home/khaledea/data/ViaLin/scripts/empty.txt $(dir $<)/classes*.dex
