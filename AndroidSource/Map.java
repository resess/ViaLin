...
public interface Map<K, V> {
    ...
    PathTaint[] taintField = new PathTaint[1];
    default void addTaint(PathTaint taint) {
        taintField[0] = taint;
    }

    default PathTaint getTaint() {
        return taintField[0];
    }

    int[] taintFieldTaintDroid = new int[1];
    default void addTaint(int taint) {
        taintFieldTaintDroid[0] = taint;
    }

    default int getTaintTaintDroid() {
        return taintFieldTaintDroid[0];
    }
